...
class CliCommand extends Command<void> {
  @override
  String get description => 'Starts a bash shell allowing you to interact with the container.';
  ...
  void run() {
    ...
    if (container.isRunning) {
      'docker exec -it ${config.containerid} /bin/bash'.start(nothrow: true, terminal: true);
    } else {

...
class Environment {
  ...
  set certbotHTTPAuthHookPath(String path) =>
      setEnv('CERTBOT_HTTP_AUTH_HOOK_PATH', path);

  String get certbotHTTPCleanupHookPath =>
      env('CERTBOT_HTTP_CLEANUP_HOOK_PATH');
  set certbotHTTPCleanupHookPath(String path) =>
      setEnv('CERTBOT_HTTP_CLEANUP_HOOK_PATH', path);

...
RUN echo 'forcing source update' # update-source: 372eaaf7-0d0f-429b-8d1d-e2cc9b8f26f8
...
#######################################################
#
### Setup NGINX 1.25 so we have http3 support
#
# Once nginx quic becomes stable we can revert the below section to using
# the standard apt install - probably from 24.04 or 24.10
#
...
# config nginx 
# RUN useradd nginx - no longer required.
